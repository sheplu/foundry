...
<template>
  ...
  <div class="navbar-row" data-testid="navbar-row">
    <foundry-navbar
    ...
    >
      ...
      <button slot="actions" type="button" data-testid="navbar-action">Sign in</button>
    </foundry-navbar>
  </div>
  ...
  <main>
    ...
    <section>
      ...
      <div class="searchable-row" data-testid="searchable-row">
        <foundry-select
